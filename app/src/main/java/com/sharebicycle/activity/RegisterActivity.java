...
public class RegisterActivity extends FatherActivity implements OnClickListener {
    ...
    private void getServerInfo() {
        ...
        x.http().get(params, new WWXCallBack("UserProtocol") {
            ...
            public void onAfterSuccessOk(JSONObject data) {
                PublicWay.startWebViewActivity(RegisterActivity.this, "注册协议",
    ...
    private void doRegister() {
        ...
        x.http().get(params, new WWXCallBack("Register") {
            ...
            public void onAfterSuccessOk(JSONObject data) {
                ...
                MyApplication.getInstance().setSessionId(userId);
