...
public class MyFoucsHouseListActivity extends FatherActivity {
    ...
    protected void initView() {
        ...
        mAdapter = new BaseRecyclerAdapter<Message>(this, list, R.layout.real_eatate_list) {
            @Override
